This project is an index library for online vector management, our key idea is Ranging Augmented Navigation Indexing Approach, while some typical state-\/or-\/art is also included \hypertarget{index_supported}{}\doxysection{data format}\label{index_supported}
...
Please find the class named Rania\+\_\+\+Python for python APIs 