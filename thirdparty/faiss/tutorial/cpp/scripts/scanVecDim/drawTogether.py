...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/scanVecDim/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/scanVecDim"
