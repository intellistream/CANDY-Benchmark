...
//                }
//            }
      if (index_type == "IVFPQ" || index_type == "PQ" || index_type == "LSH" || index_type == "flat") {
        if (tempIdx >= 0) {
...
bool CANDY::FaissIndex::deleteTensor(torch::Tensor &t, int64_t k) {
...
bool CANDY::FaissIndex::deleteTensorByIndex(std::vector<faiss::idx_t> &idx){
