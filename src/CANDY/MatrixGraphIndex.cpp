/*! \file MatrixGraphIndex.cpp*/
//
// Created by tony on 25/05/23.
//

#include <CANDY/MatrixGraphIndex.h>
...
bool CANDY::MatrixGraphIndex::setConfig(INTELLI::ConfigMapPtr cfg) {
...
bool CANDY::MatrixGraphIndex::insertTensor(torch::Tensor &t) {
...
std::vector<torch::Tensor> CANDY::MatrixGraphIndex::searchTensor(torch::Tensor &q, int64_t k) {
...
torch::Tensor CANDY::MatrixGraphIndex::genCompressedSimilarityMask (torch::Tensor &t, int64_t cols,bool circle) {
  /**
...
bool CANDY::MatrixGraphIndex::loadInitialTensorInline(torch::Tensor &t) {
...
bool CANDY::MatrixGraphIndex::loadInitialTensor(torch::Tensor &t) {
...
torch::Tensor CANDY::MatrixGraphIndex::collectDataRows(torch::Tensor &idx) {
...
int64_t CANDY::MatrixGraphIndex::searchSingleRowIdx(torch::Tensor &q,int64_t maxIter) {
...
bool CANDY::MatrixGraphIndex::insertTensorBatch(torch::Tensor &t, int64_t maxIter,int64_t cudaDev) {
...
torch::Tensor CANDY::MatrixGraphIndex::distanceIP(torch::Tensor &db,
                                                   torch::Tensor &query,
                                                   int64_t cudaDev,
                                                   MatrixGraphIndex *idx) {
...
torch::Tensor CANDY::MatrixGraphIndex::distanceL2(torch::Tensor &db0,
                                                   torch::Tensor &_q,
                                                   int64_t cudaDev,
                                                   MatrixGraphIndex *idx) {
...
INTELLI::ConfigMapPtr CANDY::MatrixGraphIndex::getIndexStatistics() {
