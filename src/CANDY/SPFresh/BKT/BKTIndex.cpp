...
#include <chrono>
#include "CANDY/SPFresh/ResultIterator.h"
...
#undef DefineBKTParameter
            ...
            m_pGraph.RefineGraph<T>(this, indices, reverseIndices, &(ptr->m_pGraph), &(ptr->m_pTrees.GetSampleMap()));//4th arg: nullptr
...
#include "CANDY/SPFresh/DefinitionList.h"
