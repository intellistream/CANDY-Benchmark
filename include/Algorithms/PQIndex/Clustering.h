...
namespace CANDY {
/**
 * @class ClusteringParameters Algorithms/PQIndex/Clustering.h
...
/**
 *  @class ClusteringIterationStats Algorithms/PQIndex/Clustering.h
...
/**
 * @class Clustering Algorithms/PQIndex/Clustering.h
