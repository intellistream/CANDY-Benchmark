...
namespace CANDY::FLANN {
    ...
    template<typename T>
/**
 * @class BranchStruct Algorithms/FlannIndex/FlannUtils.h
...
/**
 * @class DistanceIndex Algorithms/FlannIndex/FlannUtils.h
...
/**
 * @class ResultSet Algorithms/FlannIndex/FlannUtils.h
...
/**
 * @class VisitedBitset Algorithms/FlannIndex/FlannUtils.h
 ...
 */
    ...
    template<typename T>
/**
 * @class Heap Algorithms/FlannIndex/FlannUtils.h
...
/**
 * @class UniqueRandom Algorithms/FlannIndex/FlannUtils.h
...
/**
 * @class RandomCenterChooser Algorithms/FlannIndex/FlannUtils.h
 ...
 */
    ...
    public:
        ...
        void
        operator()(int64_t k, int64_t *indices, int64_t indices_length, int64_t *centers, int64_t &centers_length) {
