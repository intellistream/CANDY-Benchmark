/*! \file FlatAMMIPIndex.h*/
//
// Created by tony on 04/01/24.
//

#ifndef CANDY_INCLUDE_CANDY_FlatAMMIPIndex_H_
#define CANDY_INCLUDE_CANDY_FlatAMMIPIndex_H_
 ...
 */
/**
 * @class FlatAMMIPIndex Algorithms/FlatAMMIPIndex.h
 * @brief The class of a flat index approach, using brutal force management for data, but approximate matrix multiplication to compute distance
 ...
 */
class FlatAMMIPIndex : public AbstractIndex {
 protected:
 ...
 * @typedef FlatAMMIPIndexPtr
 * @brief The class to describe a shared pointer to @ref  FlatAMMIPIndex

 */
typedef std::shared_ptr<class CANDY::FlatAMMIPIndex> FlatAMMIPIndexPtr;
/**
 * @ingroup  CANDY_lib_bottom
 * @def newFlatAMMIPIndex
 * @brief (Macro) To creat a new @ref  FlatAMMIPIndex shared pointer.
 */
