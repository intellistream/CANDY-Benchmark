/*! \file ParallelPartitionIndex.h*/
//
// Created by tony on 04/01/24.
//

#ifndef CANDY_INCLUDE_CANDY_PARALLELPARTITIONINDEX_H_
#define CANDY_INCLUDE_CANDY_PARALLELPARTITIONINDEX_H_
 ...
 */
/**
 * @class ParallelPartitionIndex Algorithms/ParallelPartitionIndex.h
 * @brief A basic parallel index, works under generic data partition, allow configurable index of threads,
 * following round-robin insert and map-reduce query, have an optional congestion-and-drop feature.
 ...
 */
class ParallelPartitionIndex : public CANDY::AbstractIndex {
 protected:
...
/**
 * @ingroup  CANDY_lib_container
 * @typedef ParallelPartitionIndexPtr
 * @brief The class to describe a shared pointer to @ref  ParallelPartitionIndex

 */
typedef std::shared_ptr<class CANDY::ParallelPartitionIndex> ParallelPartitionIndexPtr;
/**
 * @ingroup  CANDY_lib_container
 * @def newParallelPartitionIndex
 * @brief (Macro) To creat a new @ref  ParallelPartitionIndex shared pointer.
 */
