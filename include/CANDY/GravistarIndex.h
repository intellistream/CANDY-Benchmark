/*! \file GravistarIndex.h*/
//
// Created by tony on 04/01/24.
//

#ifndef CANDY_INCLUDE_CANDY_GravistarIndex_H_
#define CANDY_INCLUDE_CANDY_GravistarIndex_H_
...
namespace CANDY {
class GravistarIndex;
/**
 * @ingroup  CANDY_lib_bottom The main body and interfaces of library function
 * @{
 */
/**
 * @class GravistarIndex CANDY/GravistarIndex.h
 * @brief Inspired by the gravistar concepts in Xeelee, we organize vector naturally by 'gravity'
 ...
 */
class GravistarIndex : public AbstractIndex {
 protected:
  ...
  */
   ...
   */
  torch::Tensor (*distanceFunc)(torch::Tensor db, torch::Tensor query, int64_t cudaDev, GravistarIndex *idx);
  /**
   ...
   */
  static torch::Tensor distanceIP(torch::Tensor db, torch::Tensor query, int64_t cudaDev, GravistarIndex *idx);
  /**
   ...
   * @return The distance tensor, must sized [q*n], will in GPU if cuda is valid
   */
  static torch::Tensor distanceL2(torch::Tensor db, torch::Tensor query, int64_t cudaDev, GravistarIndex *idx);
 ...
 * @typedef GravistarIndexPtr
 * @brief The class to describe a shared pointer to @ref  GravistarIndex

 */
typedef std::shared_ptr<class CANDY::GravistarIndex> GravistarIndexPtr;
/**
 * @ingroup  CANDY_lib_bottom
 * @def newGravistarIndex
 * @brief (Macro) To creat a new @ref  GravistarIndex shared pointer.
 */
#define newGravistarIndex std::make_shared<CANDY::GravistarIndex>
}
/**
 * @}
 */
