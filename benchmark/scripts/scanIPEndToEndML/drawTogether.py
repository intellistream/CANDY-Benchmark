...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/scanIPE2EML/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/scanIPE2EML"
    ...
    df.to_csv(figPath + "/e2e_recall_ML.csv", float_format='%.3f')
    ...
    df.to_csv(figPath + "/e2e_qps_value_ML.csv", float_format='%.2f')
