...
def readResultVector(singleValueVec, resultPath):
    ...
    for i in singleValueVec:
        elapsedTime, cacheAccess, cacheMiss, l1dAccess, l1dMiss, llcAccess, llcMiss, totalStall = readResultSingle(i,
                                                                                                                   resultPath)
...
def main():
    ...
    groupBar2.DrawFigure(dataSetNames, l1dMissAll / l1dAccess * 100.0, methodTags, "Datasets", "L1 MISS (%)", 5, 15,
                         figPath + "L1_MISS_RATE", True)
    groupBar2.DrawFigure(dataSetNames, cacheMissAll / cacheAccessAll * 100.0, methodTags, "Datasets", "CACHE MISS (%)",
                         5, 15, figPath + "CACHE_MISS_RATE", True)
    groupBar2.DrawFigure(dataSetNames, llcMissAll / llcAccessAll * 100.0, methodTags, "Datasets", "LLC MISS (%)", 5, 15,
                         figPath + "LLC_MISS_RATE", True)

    groupBar2.DrawFigureYLog(dataSetNames, l1dMissAll, methodTags, "Datasets", "#L1 MISS", 5, 15, figPath + "L1_MISS",
                             True)
    groupBar2.DrawFigureYLog(dataSetNames, cacheMissAll, methodTags, "Datasets", "#CACHE MISS", 5, 15,
                             figPath + "CACHE_MISS", True)
    groupBar2.DrawFigureYLog(dataSetNames, llcMissAll, methodTags, "Datasets", "#LLC MISS", 5, 15, figPath + "LLC_MISS",
                             True)
