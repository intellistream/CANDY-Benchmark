...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/findOptimum/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/findOptimum"

    fields = {
        "hnswid":list(range(2000))
    }
