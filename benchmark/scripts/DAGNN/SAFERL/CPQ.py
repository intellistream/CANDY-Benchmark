...
class CPQ(object):
    ...
    def train(self, replay_buffer, batch_size=100):
        ...
        if self.total_it % 100 == 0:
            ...
            print(f'td_qr_loss is {td_qr_loss}')
            print(f'td_qc_loss is {td_qc_loss}')
            print(f'cost_critic_loss is {cost_critic_loss}')
            print(f'actor loss is {actor_loss}')
            print(f'cql_qr_loss is {cql_qr_loss}')
            print(f'cql_qc_loss is {cql_qc_loss}')
            print(f'reward_critic_loss is {reward_critic_loss}')
