...
#     plt.savefig(filename + ".pdf", bbox_inches='tight')
    ...
    # Draw a line chart with multiple lines and group names in the legend
...
# draw a line chart
def DrawFigureYnormalRaw(xvalues, yvalues, legend_labels, x_label, y_label, y_min, y_max, filename, allow_legend):
    # you may change the figure size on your own.
    fig = plt.figure(figsize=(10, 6))
    figure = fig.add_subplot(111)
    LINE_COLORS = [
