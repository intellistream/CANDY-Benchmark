...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/scanL2E2E/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/scanL2E2E"
    ...
    totalQuery = (incrementalSearchAll + pendingWaitTimeAll) / 1e6
    ...
    df = pd.DataFrame(pendingWaitTimeAll / 1000, columns=dataSetNames, index=algoDisp)
    ...
    df = pd.DataFrame(incrementalSearchAll / 1000, columns=dataSetNames, index=algoDisp)
