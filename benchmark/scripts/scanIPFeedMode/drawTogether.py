...
def runPeriod(exePath, algoTag, resultPath, configTemplate="config.csv", prefixTagRaw="null"):
    ...
    editConfig(configTemplate, "temp2.csv", "batchSize", prefixTag)
...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/scanIPFeedMode/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/scanIPFeedMode"
    ...
    groupLine.DrawFigureYLog(periodAll, (incrementalSearchAll + pendingWaitTimeAll) / 1000,
                             ...
                             figPath + "/" + "scanIPEventRateFaissHalf_lat_instant_search",
                             False)
