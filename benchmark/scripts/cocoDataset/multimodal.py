...
def main():
    ...
    images = encode_images_to_fvecs(dataset['validation']['image_path'],500,16,targetPathBase+'/query_image.fvecs')
    ...
    images = encode_images_to_fvecs(dataset['train']['image_path'],100000,16,targetPathBase+'/data_image.fvecs')
