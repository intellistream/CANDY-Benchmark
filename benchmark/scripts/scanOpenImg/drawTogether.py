...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/scanOpenImg/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/scanOpenImg"
    ...
    algoDisp = ['BrutalForce', 'LSH-H', 'PQ', 'IVFPQ', 'onlinePQ', 'HNSW', 'NSW', 'NSG', 'nnDescent']
