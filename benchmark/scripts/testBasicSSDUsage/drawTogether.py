...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/testBasicSSDUsage/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/testBaicSSDUsage"
